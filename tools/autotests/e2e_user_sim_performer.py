...
def run(base_url: str, delay_ms: int, headless: bool) -> None:
    ...
    email = f"performer_{unique}@example.com"
    password = "StrongPass123!"
    name = f"Performer {unique}"
    ...
    with sync_playwright() as p:
        ...
        page.get_by_text("Performer dashboard access granted").wait_for(timeout=10000)

        # role guard check
        page.goto(f"{base_url}/advertiser/home")
...
def main() -> None:
    ...
    print("E2E performer simulation: PASS")
